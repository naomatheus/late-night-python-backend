...
class Comment(Resource):
	def __init__(self):
		...
		def post(self):
			print('comment post route')
			response = make_response(self, {'Content-Type': 'application/json'})
...
class Restaurant(Resource):
	...
	def get(self):   
		...
		print(url,'<--- this is the we\'re about to call')
...
class RestaurantComment(Resource):
	...
	def post(self, user_id):
		...
		# restaurant_check = models.Restaurant.select(**args)
		# print('checking for restaurant')
		# print(g.user._get_current_object())
		# if foundRestaurant:
		# 	print(args, '<==== args (req.body')
		# 	restaurant = models.Comment.create(**args)
